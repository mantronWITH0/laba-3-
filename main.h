...
void Sprite_animation(GLuint texture, int n, Hero *obj)
{
    ...
    static float line[]= {0,0, 0,0, 0,0, 0,0};
...
void Main_Init()
{
    ...
    Load_Texture("spriteList.png", &sprite, GL_CLAMP, GL_CLAMP, GL_NEAREST);
    Load_Texture("fon.png", &background, GL_REPEAT, GL_CLAMP, GL_NEAREST);
}

void Menu_Init(){
    Menu_AddButton("Play", 950,10.0,100.0,30.0, 2);
    Menu_AddButton("Pause", 950,50.0,100.0,30.0,2);
    Menu_AddButton("Quit", 950,90.0,100.0,30.0,2);
}
